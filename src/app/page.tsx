...
import { GraduationCap, Users, Building2, ShieldAlert, Link2, Brain } from "lucide-react";
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-20 pb-16 sm:pt-32 sm:pb-24">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-white mb-4 tracking-tight">
              BoleChain{" "}
              <span className="text-amber-400">伯乐智信</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
            <Link href="/register?role=student">
              <Button
                size="lg"
                className="w-64 bg-blue-600 hover:bg-blue-700 text-white text-lg h-14 gap-2"
              >
            ...
            <Link href="/register?role=parent">
              <Button
                size="lg"
                className="w-64 bg-green-600 hover:bg-green-700 text-white text-lg h-14 gap-2"
              >
                <Users className="w-5 h-5" />
                家长入口 Parent
              </Button>
            </Link>
            <Link href="/register?role=counselor">
              <Button
                size="lg"
                className="w-64 bg-amber-500 hover:bg-amber-600 text-slate-900 text-lg h-14 gap-2 font-semibold"
              >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-red-200/70 text-sm">
                    香港大学近年拦截数百宗使用伪造学历文件的入学申请，涉及伪造成绩单、推荐信及语言考试成绩
                  </p>
                  <Badge variant="outline" className="mt-3 text-red-300 border-red-500/40">
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-red-200/70 text-sm">
                    香港警方破获126宗涉及伪造学历的刑事案件，部分涉及跨境犯罪集团系统性伪造留学申请材料
                  </p>
                  <Badge variant="outline" className="mt-3 text-red-300 border-red-500/40">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur hover:border-amber-500/30 transition-colors">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">三方协同</h3>
              <p className="text-blue-200/70 text-sm">
                学生、家长、顾问三角色协同，透明可追溯
              </p>
            </CardContent>
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-white/40 text-sm">
            © 2026 BoleChain 伯乐智信. All rights reserved.
          </p>
          <p className="text-white/30 text-xs mt-1">
            Empowering cross-border education with AI & Blockchain
          </p>
        </div>
      </footer>
    </div>
